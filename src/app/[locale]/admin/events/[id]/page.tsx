...
export default function AdminEventDetailPage() {
  ...
  const getStatusText = (status: string) => {
    switch (status) {
      case 'YES': return t('rsvp.yes')
      case 'NO': return t('rsvp.no')
      case 'MAYBE': return t('rsvp.maybe')
      default: return t('rsvp.pending')
    }
  }
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex space-x-1">
                  <Link href={`/en/admin/events/${params.id}`} className={`text-sm px-2 py-1 rounded ${locale === 'en' ? 'bg-primary-100 text-primary-700' : 'text-gray-600 hover:text-gray-900'}`}>
                    EN
                  </Link>
                  <Link href={`/ru/admin/events/${params.id}`} className={`text-sm px-2 py-1 rounded ${locale === 'ru' ? 'bg-primary-100 text-primary-700' : 'text-gray-600 hover:text-gray-900'}`}>
                    РУС
                  </Link>
                  <Link href={`/kk/admin/events/${params.id}`} className={`text-sm px-2 py-1 rounded ${locale === 'kk' ? 'bg-primary-100 text-primary-700' : 'text-gray-600 hover:text-gray-900'}`}>
                    ҚАЗ
                  </Link>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-2">
                ...
                <p><strong>Max Guests:</strong> {event.maxGuests}</p>
                <p><strong>Table Size:</strong> {event.tableSize}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">{t('admin.totalGuests')}</p>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">{t('admin.attending')}</p>
                </div>
              </div>
        ...
        <div className="card">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">
            {t('admin.guestList')} ({filteredGuests.length})
          </h3>
